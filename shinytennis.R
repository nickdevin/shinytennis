...
results2020 = stats_by_year(read.csv(file = './tennis/wta_matches_2020.csv', header = TRUE))
results2019 = stats_by_year(read.csv(file = './tennis/wta_matches_2019.csv', header = TRUE))
results2018 = stats_by_year(read.csv(file = './tennis/wta_matches_2018.csv', header = TRUE))
results2017 = stats_by_year(read.csv(file = './tennis/wta_matches_2017.csv', header = TRUE))
results2016 = stats_by_year(read.csv(file = './tennis/wta_matches_2016.csv', header = TRUE))
results2015 = stats_by_year(read.csv(file = './tennis/wta_matches_2015.csv', header = TRUE))
results2014 = stats_by_year(read.csv(file = './tennis/wta_matches_2014.csv', header = TRUE))
results2013 = stats_by_year(read.csv(file = './tennis/wta_matches_2013.csv', header = TRUE))
results2012 = stats_by_year(read.csv(file = './tennis/wta_matches_2012.csv', header = TRUE))
results2011 = stats_by_year(read.csv(file = './tennis/wta_matches_2011.csv', header = TRUE))
...
#want to:
## compare h2h between players of different types
## define ADAPTABILITY
## see if there is a relationship between h2h and adaptability